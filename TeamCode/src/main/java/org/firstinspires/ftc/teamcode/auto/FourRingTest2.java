 ...
 */
@TeleOp(group = "drive", name = "Four Ring Test 2")
public class FourRingTest2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory R4_toStack_p3 = drive.trajectoryBuilder(R4_toStack_p2.end())
                .lineToLinearHeading(new Pose2d(-17, 35, Math.toRadians(180)),
                        new MinVelocityConstraint(
                                Arrays.asList(
                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                        new MecanumVelocityConstraint(20, DriveConstants.TRACK_WIDTH)
        ...
        Trajectory R4_toStack_p4 = drive.trajectoryBuilder(R4_toStack_p3.end())
                .lineToLinearHeading(new Pose2d(-21, 35, Math.toRadians(180)),
                        new MinVelocityConstraint(
                                Arrays.asList(
                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                        new MecanumVelocityConstraint(20, DriveConstants.TRACK_WIDTH)
        ...
        Trajectory R4_toStack_p5 = drive.trajectoryBuilder(R4_toStack_p4.end())
                .lineToLinearHeading(new Pose2d(-28, 35, Math.toRadians(170)),
                        new MinVelocityConstraint(
                                Arrays.asList(
                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                                        new MecanumVelocityConstraint(20, DriveConstants.TRACK_WIDTH)
        ...
        Trajectory R4_toShoot_last = drive.trajectoryBuilder(R4_toStack_p5.end())
                .lineToLinearHeading(new Pose2d(-5, 35, Math.toRadians(188)))
                .build();
